defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Agent do
    ...
    defmodule Routing do
      ...
      @primary_key false
      embedded_schema do
        field(:claude_label, :string, default: "claude")
        field(:codex_label, :string, default: "codex")
      end

      @spec changeset(%__MODULE__{}, map()) :: Ecto.Changeset.t()
      def changeset(schema, attrs) do
        schema
        |> cast(attrs, [:claude_label, :codex_label], empty_values: [])
      end
    end
    ...
    embedded_schema do
      ...
      field(:default, :string, default: "claude")
    ...
    def changeset(schema, attrs) do
      ...
      |> cast(
        attrs,
        [:max_concurrent_agents, :max_turns, :max_retry_backoff_ms, :max_concurrent_agents_by_state, :default],
        empty_values: []
      )
      ...
      |> validate_inclusion(:default, ["claude", "codex"])
  ...
  defmodule Claude do
    ...
    embedded_schema do
      ...
      field(:disallowed_tools, {:array, :string})
  ...
  defp finalize_settings(settings) do
    api_key_fallback =
      case settings.tracker.kind do
        "github_project" -> System.get_env("GITHUB_TOKEN") || System.get_env("GH_TOKEN")
